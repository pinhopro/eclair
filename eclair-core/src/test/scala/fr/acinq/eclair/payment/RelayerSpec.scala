...
class RelayerSpec extends TestkitBaseClass {
  ...
  test("get usable balances") { f =>
    ...
    val UsableBalances(usableBalances1) = sender.expectMsgType[UsableBalances]
    ...
    sender.send(relayer, GetUsableBalances)
    val UsableBalances(usableBalances2) = sender.expectMsgType[UsableBalances]
    ...
    sender.send(relayer, GetUsableBalances)
    val UsableBalances(usableBalances3) = sender.expectMsgType[UsableBalances]
    ...
    sender.send(relayer, GetUsableBalances)
    val UsableBalances(usableBalances4) = sender.expectMsgType[UsableBalances]
    ...
    sender.send(relayer, GetUsableBalances)
    val UsableBalances(usableBalances5) = sender.expectMsgType[UsableBalances]
